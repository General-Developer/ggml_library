...
class GgmlLibrary extends GgmlLibraryBase {
  ...
  static late final GgmlLibrarySharedBindingsByGeneralDeveloper
      _ggmlLibraryDartSharedBindingsByGeneralDeveloper;
  ...
  bool loadWhisperModel({
    ...
    final cparams = _ggmlLibraryDartSharedBindingsByGeneralDeveloper
  ...
  Future<Map> transcribeToJson({
    ...
    if (_ggmlLibraryDartSharedBindingsByGeneralDeveloper
    ...
    int maxContext = -1;
    final wparams = _ggmlLibraryDartSharedBindingsByGeneralDeveloper
    ...
    final int resultInference = () {
      ...
      return GgmlLibrary._ggmlLibraryDartSharedBindingsByGeneralDeveloper
          .whisper_full(
        whisperModelContext,
        wparams,
        pointerFilePcm32,
  ...
  void close() {
    ...
    final whisperModelContext = GgmlLibrary._whisperModelContext;
    if (whisperModelContext != null) {
      GgmlLibrary._ggmlLibraryDartSharedBindingsByGeneralDeveloper
          .whisper_free(whisperModelContext);
    }
  }
