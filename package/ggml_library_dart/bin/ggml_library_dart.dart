...
// import 'package:ggml_library_dart/babylon/src/bindings.dart';
// import "package:path/path.dart" as path;

// class TextToSpeechGgmlLibrary {
//   final Directory directoryTemp;
//   TextToSpeechGgmlLibrary({
...
//         _lib = BabylonIo(DynamicLibrary.open('tts_ggml_library_dart.dll'));
//       } else if (Platform.isLinux || Platform.isAndroid) {
//         _lib = BabylonIo(DynamicLibrary.open('/home/galaxeus/Documents/github/general-developer/ggml_library_dart/package/ggml_library_dart_flutter/linux/libtts_ggml_library_dart.so'));
//       } else if (Platform.isMacOS || Platform.isIOS) {
//         _lib = BabylonIo(DynamicLibrary.open('libtts_ggml_library_dart.dylib'));
//       } else {
...
//       return File(
//         "/home/galaxeus/Documents/github/general-developer/ggml_library_dart/package/ggml_library_dart/models/deep_phonemizer.onnx",
//       );
//     });

//     final File vitsModel = await Future(() async {
//       return File(
//         "/home/galaxeus/Documents/github/general-developer/ggml_library_dart/package/ggml_library_dart/models/amy.onnx",
//       );
//     });
...
//   final TextToSpeechGgmlLibrary textToSpeechGgmlLibrary = TextToSpeechGgmlLibrary(
//     directoryTemp: Directory(path.join(Directory.current.path, "temp")),
//   );

//   await textToSpeechGgmlLibrary.init();

//   final String text = "Hello World";
//   final result = textToSpeechGgmlLibrary.createSpeech(text: text);
//   print(result);
